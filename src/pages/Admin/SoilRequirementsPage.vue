<template>
  <q-page>
    ...
    <CreateSoilRequirement
      ref="createSoilRequirementRef"
      @created="(e) => requirement.unshift(e)"
      @update:item="
        (e) => {
          requirement = requirement.map((x) => {
            x.id == e.id && (x = e);
            return x;
          });
        }
...
const createSoilRequirementRef = ref();
const sales_column = [
  {
    name: "crop",
    label: "Crop",
...
const {
  ...
  () =>
    alova.Get(`admin/soil/requirements`, {
      params: {
